<x-guest-layout>
    <main class="grid grid-cols-4 gap-8 mt-8 wrapper">
        ...
        <aside class="flex flex-col items-center h-full p-4 space-y-3 bg-white shadow">
            @if(request()->routeIs('profile'))
            <span class="flex flex-col items-center text-sm transition border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300">
            ...
            @auth
                ...
                <div class="">
                    @if(auth()->user()->isFollowing($user))
                        <x-form action="{{route('user.follow', $user)}}">
                            <x-jet-button>
                                {{__('Unfollow')}}
                            </x-jet-button>
                        </x-form>
            ...
            <div class="flex flex-col pt-8 space-y-3">
